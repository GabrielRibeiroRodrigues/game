class Collider:
    ...
    def checkX(self):
        ...
        try:
            ...
            # entidade fora da grade vertical: sem tiles para colidir no eixo X
            return
        for row in rows:
    ...
    def checkY(self):
        ...
        try:
            ...
            # caiu abaixo da grade do nivel = buraco: jogador morre,
            # entidades sem gameOver() sao removidas
            try:
